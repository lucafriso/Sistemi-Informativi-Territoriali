	...
	<body>
		...
		<div id='container'>
			...
			<header class = "masthead d-flex">
				...
				<!--dopo homepage.php bisgona controllare questa cosa : ?check=1&reg=true -->
	    		
					<form class="text-center border border-light p-5" action = "registerform.php?check=1&reg=true" method = "POST">
		...
		<center>
	    <!--Richiesta di connessione al database-->
			...
			<header class = "masthead d-flex"
	    		...
	    		<div class= 'container'>
	    			<div class='col'>
	    				...
	    				<a href = "./registerform.php?reg=true">
		    	...
		    	if (isset($_GET['reg'])) {
		    		if ($_GET['reg'] == true) {
				        ...
				        if ($_POST['name'] == "") {
					        ...
					        header("location: ./registerform.php?reg=true");
				        }
				        if ($_POST['surname'] == "") {
				        ...
				        if (strlen($_POST['user']) < 8) {
					        ...
					        $dati = pg_fetch_array($query, 0);
					  		if ($dati['numero'] != 0) {
					        	...
					        	header("location: ./registerform.php?reg=2");
					        }
				        }
		        	}
		  		}
